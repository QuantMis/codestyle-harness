...
|-------|----------|---------|
| [`livewire-project-init`](./livewire-project-init/STYLE.md) | Day-0 scaffold of a Laravel + Livewire app — install command, skeleton, quality-gate baseline. DB-independent (SQLite); pulls in Flux UI. | `crud-controller` |
